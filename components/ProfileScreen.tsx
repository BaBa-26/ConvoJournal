...
// The account/identity page. Everything about *who you are* lives here; app configuration
// (appearance, layout, background) lives on the separate Settings page. Name changes persist
// immediately via patchPrefs, so this page needs no save-gate.
  ...
  return (
    <div className="flex flex-col flex-1 overflow-hidden animate-fade-in">
      <header className="px-5 pt-safe pt-5 pb-4 flex-shrink-0">
        <p className="font-mono text-[10px] text-parchment-700 uppercase tracking-[0.2em]">account</p>
        <h1 className="font-display italic text-2xl text-parchment-100 leading-tight mt-1">your profile</h1>
      </header>
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-nav space-y-4">
        ...
        {/* Bridge to app settings */}
        <Link
          href="/settings"
          className="card flex items-center justify-between hover:border-ink-600 transition-colors"
        >
          <div>
            <p className="font-mono text-sm text-parchment-200">App settings</p>
            <p className="font-mono text-[11px] text-parchment-700 mt-0.5">
              Appearance, Today layout, background &amp; more
            </p>
          </div>
